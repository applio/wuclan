...
#      1   9999999        20090421232814                    1             old_scraper     20090421232814  200     old_scraper     [{"user":{"followers_count":1,"description":null,"url":null,"profile_image_url":"http:\/\/static.twitter.com
#      1   9999999        20090422065945                    1             old_scraper     20090422065945  200     old_scraper     [{"user":{"followers_count":118,"description":"Curiosa, consultora de IT y madre a la vez!","url":"","profil
#      1   9999999        20090422083321                    1             old_scraper     20090422083321  200     old_scraper     [{"user":{"followers_count":14,"description":"","url":"http:\/\/www.myspace.com /sweetitdm","profile_image_u
#      1   9999999        20090423045905                    1             old_scraper     20090423045905  200     old_scraper     [{"user":{"followers_count":79,"description":"","url":"http:\/\/flickr.com      /photos\/malugreen","profile_imag
#      1   9999999        20090423063900                    1             old_scraper     20090423063900  200     old_scraper     [{"user":{"followers_count":388,"description":"Instructional technology grad student, dog lover, optimist,an
#      1   9999999        20090423135519                    1             old_scraper     20090423135519  200     old_scraper     [{"user":{"followers_count":628,"description":"MsBeat runs the show at Beatblogging.org. A news-savvy mistre
#      1   9999999        20090425052649                    1             old_scraper     20090425052649  200     old_scraper     [{"user":{"followers_count":12,"description":"mixiãã£ã¦ã¾ããããµãããããã§æ¤ç´¢ãã¦ã¿<E3>
#      1   9999999        20090426061449                    1             old_scraper     20090426061449  200     old_scraper     [{"user":{"followers_count":5,"description":"im in the land of soft drugs, legal whoring, windmills and tuli
#      1   9999999        20090428044727                    1             old_scraper     20090428044727  200     old_scraper     [{"user":{"followers_count":290,"description":"Online and Onair radioshow for geeks only!","url":"http:\/\/w
#      1   9999999        20090428151030                    1             old_scraper     20090428151030  200     old_scraper     [{"user":{"followers_count":520,"description":"The official home of New Zealand Rugby on Twitter","url":"htt
#      1   9999999        20090428232804                    1             old_scraper     20090428232804  200     old_scraper     [{"user":{"followers_count":3,"description":null,"url":null,"profile_image_url":"http:\/\/static.twitter.com
#      1   9999999        20090503152828                    1             old_scraper     20090503152828  200     old_scraper     [{"user":{"followers_count":49,"description":"","url":"http:\/\/www.myspace.com /silisali","profile_image_ur
#      1   9999999        20090503195932                    1             old_scraper     20090503195932  200     old_scraper     [{"user":{"followers_count":35,"description":"I am a national level bodybuilder working for Bodywell Nutriti
#      1   9999999        20090504020126                    1             old_scraper     20090504020126  200     old_scraper     [{"user":{"followers_count":35,"description":"Christian. Bass Player. Singer. Amateur Photographer. News Adv
#      1   9999999        20081209232718                    1             old_scraper     20081209232718  200     old_scraper     [{"user":{"followers_count":105,"description":"æ­å¹ââæ±äº¬é »ç¹ãITç³»,åºåç³»,ãã©ã³ãã¼,<E5><85>1   9999999        20081210061628                    1             old_scraper     20081210061628  200     old_scraper     [{"user":{"followers_count":736,"description":"I AM","url":"http:\/\/www.frankvandun.nl","profile_image_url"
#      1   9999999        20081210185703                    1             old_scraper     20081210185703  200     old_scraper     [{"user":{"followers_count":644,"description":"Noticias de Chile actualizadas cada hora","url":"http:\/\/www
#      1   9999999        20081211095702                    1             old_scraper     20081211095702  200     old_scraper     [{"user":{"followers_count":64,"description":"","url":"http:\/\/tautin.blogspot.com     /","profile_image_url":"  1   9999999        20081213073636                    1             old_scraper     20081213073636  200     old_scraper     [{"user":{"followers_count":178,"description":"","url":"http:\/\/www.gazetadopovo.com.br","profile_image_url
#      1   9999999        20081214100003                    1             old_scraper     20081214100003  200     old_scraper     [{"user":{"followers_count":7,"description":"ResearchBlogging.org feeds in Deutsch","url":"http:\/\/research
#      1   9999999        20081215105211                    1             old_scraper     20081215105211  200     old_scraper     [{"user":{"followers_count":165,"description":"I am a stay-at-home mother of two, with one on the way! I am
#      1   9999999        20081218075108                    1             old_scraper     20081218075108  200     old_scraper     [{"user":{"followers_count":17,"description":"","url":"http:\/\/hard-hitting-news.blogspot.com  /","profile_i
#      1   9999999        20081219065853                    1             old_scraper     20081219065853  200     old_scraper     [{"user":{"followers_count":2,"description":"","url":"","profile_image_url":"http:\/\/static.twitter.com
...
#      1   9999999        20081220010525                    1             old_scraper     20081220010525  200     old_scraper     [{"user":{"followers_count":202,"description":null,"url":null,"profile_image_url":"http:\/\/static.twitter.c
#      1   9999999        20081220113649                    1             old_scraper     20081220113649  200     old_scraper     [{"user":{"followers_count":42,"description":"Contrary to popular belief, I am in fact a robot.","url":"http
#      1   9999999        20081221083623                    1             old_scraper     20081221083623  200     old_scraper     [{"user":{"followers_count":565,"description":"çãç³»ãã­ã°ã©ã","url":"http:\/\/polog.org      /","profi 1   9999999        20081224110505                    1             old_scraper     20081224110505  200     old_scraper     [{"user":{"followers_count":304,"description":"  A group of  green women bloggers, uniting our voices to hel
#      1   9999999        20081225055913                    1             old_scraper     20081225055913  200     old_scraper     [{"user":{"followers_count":213,"description":"åäººã²ã¼ã ä½ã£ã¦ã¾ããããæ°è»½ã«ãã©ã­ã¼<E3>   1   9999999        20081229072914                    1             old_scraper     20081229072914  200     old_scraper     [{"user":{"followers_count":15,"description":"","url":"http:\/\/www.rodia.info","profile_image_url":"http:
#       /
#      1   9999999        20081229084830                    1             old_scraper     20081229084830  200     old_scraper     [{"user":{"followers_count":191,"description":"3rd Generation Real Estate Investor and Author","url":"http:\
#      1   9999999        20090102103315                    1             old_scraper     20090102103315  200     old_scraper     [{"user":{"followers_count":21,"description":"takin over one city at a time","url":"","profile_image_url":"h
#      1   9999999        20090104084017                    1             old_scraper     20090104084017  200     old_scraper     [{"user":{"followers_count":299,"description":"ã¹ã¦ã£ã¼ãï¼åªï¼ã12æéããã¨ããã¦ãå°±<E5><AF>1   9999999        20090105101608                    1             old_scraper     20090105101608  200     old_scraper     [{"user":{"followers_count":2171,"description":"LIVE wildlife 24\/7 from Djuma in South Africa. LIVE safari.
#      1   9999999        20090105103520                    1             old_scraper     20090105103520  200     old_scraper     [{"user":{"followers_count":19,"description":"Learning to dance like no one is watching","url":"","profile_i
#      1   9999999        20090106165730                    1             old_scraper     20090106165730  200     old_scraper     [{"user":{"followers_count":10,"description":"Live.Love.Laugh.","url":"","profile_image_url":"http:\/\/s3.am
#      1   9999999        20090112091101                    1             old_scraper     20090112091101  200     old_scraper     [{"user":{"followers_count":25,"description":"Ostravak je stav duÅ¡e, i kdyÅ¾ ÄlovÄk Å¾ije v Praze.","url"
#      1   9999999        20090117090748                    1             old_scraper     20090117090748  200     old_scraper     [{"user":{"followers_count":58,"description":"Moving on up.","url":"http:\/\/sarah-dear.blogspot.com","profi
...
#      1   9999999        20090503195932                    1             old_scraper     20090503195932  200     old_scraper     [{"user":{"followers_count":35,"description":"I am a national level bodybuilder working for Bodywell Nutriti
#      1   9999999        20090504020126                    1             old_scraper     20090504020126  200     old_scraper     [{"user":{"followers_count":35,"description":"Christian. Bass Player. Singer. Amateur Photographer. News Adv
#      1   9999999        20090504045337                    1             old_scraper     20090504045337  200     old_scraper     [{"user":{"followers_count":171,"description":"i'm a bboy and a multimedia designer","url":"http:\/\/pitiscm
#      1   9999999        20090507112755                    1             old_scraper     20090507112755  200     old_scraper     [{"user":{"followers_count":2,"description":"","url":"","profile_image_url":"http:\/\/static.twitter.com
#      1   9999999        20090509222228                    1             old_scraper     20090509222228  200     old_scraper     [{"user":{"followers_count":256,"description":"representing NJ\/NY","url":"http:\/      /www.myspace.com\/darknes
#      1   9999999        20090512052820                    1             old_scraper     20090512052820  200     old_scraper     [{"user":{"followers_count":0,"description":null,"url":null,"profile_image_url":"http:\/\/static.twitter.com
#      1   9999999        20090512101017                    1             old_scraper     20090512101017  200     old_scraper     [{"user":{"followers_count":685,"description":"Gainfully employed doing Linux 'stuff', part-time fitness fan
#      1   9999999        20090513062843                    1             old_scraper     20090513062843  200     old_scraper     [{"user":{"followers_count":7,"description":"Non-commercial radio for everyone who loves original music and
#
